#!/usr/bin/python2
#coding=utf-8
#The Credit For This Code Goes To wajdan
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #Dev:wajdan
	    time.sleep(2)
            loop = 'false'
        else:
	...
	try:
		...
		if 'save-device' in url:
			try:
				...
				os.system('xdg-open https://m.youtube.com/channel/UCGumJacDLNk2aylQpu8ZGVA')
...
def menu():
	...
	try:
		...
		os.system('clear')
		print"\033[1;91mMake a New Account"
		os.system('rm -rf login.txt')
		time.sleep(1)
		login()
	except requests.exceptions.ConnectionError:
	...
	print "\033[1;95m♡──────•◈•──────♡\033[1;96mawaistaqi\033[1;95m♡──────•◈•──────♡"
...
def pilih_super():
	...
	if peak =="":
		...
		try:
			...
			print"\x1b[1;92mWakeup and try again!"
	...
	p.map(main, id)
	print "\033[1;95m♡─────────•◈•─────────♡\033[1;96mawaistaqi\033[1;95m♡─────────•◈•─────────♡"
	print "  \033[1;93m«---•◈•---Developed By awaistaqi---•◈•---»" #Dev:wajdan
	...
	print """
             ...
             ...........
♡─────────────•◈•─────────────♡.
: \033[1;96m .....awaistaqi  wajdan..... \033[1;93m :
♡─────────────•◈•─────────────♡.' 
                whatsapp Num
               +923019069766"""
